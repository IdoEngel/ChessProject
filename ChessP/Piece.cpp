...
bool Piece::isDiagnollyRightW(const std::string& dstPosition)
{
...
bool Piece::isDiagnollyLeftW(const std::string& dstPosition)
{
	if (dstPosition[START_POSITION_LETTER] - 1 == dstPosition[DST_POSITION_LETTER] &&
		dstPosition[START_POSITION_NUMBER] + 1 == dstPosition[DST_POSITION_NUMBER])
	{
...
bool Piece::isDiagnollyLeftB(const std::string& dstPosition)
{
	if (dstPosition[START_POSITION_LETTER] - 1 == dstPosition[DST_POSITION_LETTER] &&
		dstPosition[START_POSITION_NUMBER] - 1 == dstPosition[DST_POSITION_NUMBER])
	{
...
bool Piece::isDiagnollyRightB(const std::string& dstPosition)
{
	if (dstPosition[START_POSITION_LETTER] + 1 == dstPosition[DST_POSITION_LETTER] &&
		dstPosition[START_POSITION_NUMBER] - 1 == dstPosition[DST_POSITION_NUMBER])
	{
